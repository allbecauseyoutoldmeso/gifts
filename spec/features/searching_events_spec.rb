...
feature 'searching events', js: true do
  scenario 'user searches by name' do
    ...
    click_button(I18n.t('events.index.search_events'))
    fill_in(I18n.t('simple_form.labels.event_search.name'), with: 'Birthday')
    click_button(I18n.t('helpers.submit.event_search.create'))
  ...
  scenario 'user searches by start_date' do
    ...
    click_button(I18n.t('events.index.search_events'))
    fill_in(
      I18n.t('simple_form.labels.event_search.start_date'),
  ...
  scenario 'user searches by end_date' do
    ...
    click_button(I18n.t('events.index.search_events'))
    fill_in(
      I18n.t('simple_form.labels.event_search.end_date'),
      with: input_date(Date.current)
    )
    click_button(I18n.t('helpers.submit.event_search.create'))
  ...
  scenario 'user searches by recipient' do
    ...
    select(
      recipient.name,
      from: I18n.t('simple_form.labels.event_search.recipient_id')
    )
    click_button(I18n.t('helpers.submit.event_search.create'))
